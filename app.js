...
var scoredata, scoring, overs, count, player = 0, outplayers = [];
var players_score = [0, 0, 0, 0];
var players_balls = [0, 0, 0, 0];
var finalscore = [], notoufinalscore = [];
var players = [0, 0, 0, 0];
var players_name = ["Kirat Boli", "N.S.Nodhi", "R Rumrah", "Shashi Henra"];
var names = ["Kirat Boli", "N.S.Nodhi", "R Rumrah", "Shashi Henra"];
var runs = 40, finaloutput = 0;
var traverse;
var ball_left = 24;
